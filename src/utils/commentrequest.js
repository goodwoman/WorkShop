...
// request interceptor
commentRequest.interceptors.request.use((config) => {  
...
commentRequest.interceptors.response.use((response) => {
...
const installer = {
    vm: {},
    install(Vue) {
        Vue.use(VueAxios, commentRequest);
    },
};

export default commentRequest;

export { installer as VueAxios, commentRequest as axios };